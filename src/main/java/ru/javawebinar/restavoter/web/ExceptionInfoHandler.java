...
import ru.javawebinar.restavoter.util.exception.ErrorInfo;
import ru.javawebinar.restavoter.util.exception.ErrorType;
import ru.javawebinar.restavoter.util.exception.IllegalRequestDataException;
...
public class ExceptionInfoHandler {
    ...
    private static final Map<String, String> CONSTRAINS_ERROR_MESSAGES = Map.of(
            ...
            "user_votes_idx", "The user has already voted today");
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        ...
        if (rootMsg != null) {
            ...
            for (Map.Entry<String, String> entry : CONSTRAINS_ERROR_MESSAGES.entrySet()) {
